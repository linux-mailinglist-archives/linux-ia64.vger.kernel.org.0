...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D638B84D2B
	for <lists+linux-ia64@lfdr.de>; Wed,  7 Aug 2019 15:33:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388240AbfHGNbv (ORCPT <rfc822;lists+linux-ia64@lfdr.de>);
        Wed, 7 Aug 2019 09:31:51 -0400
Received: from bombadil.infradead.org ([198.137.202.133]:60686 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388514AbfHGNbu (ORCPT
        <rfc822;linux-ia64@vger.kernel.org>); Wed, 7 Aug 2019 09:31:50 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=TOCW/4OKRw79LFfaqEA6a+QC4JlzNA+HyeUlwKvyA64=; b=d+n0JxgkLf7a4ObxOmw1VLwgI9
        ;
Received: from [195.167.85.94] (helo=localhost)
        by bombadil.infradead.org with esmtpsa (Exim 4.92 #3 (Red Hat Linux))
        id 1hvM2d-0008Ae-MI; Wed, 07 Aug 2019 13:31:49 +0000
From:   Christoph Hellwig <hch@lst.de>
To:     Tony Luck <tony.luck@intel.com>, Fenghua Yu <fenghua.yu@intel.com>
Cc:     Arnd Bergmann <arnd@arndb.de>,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        linux-ia64@vger.kernel.org, linux-kernel@vger.kernel.org
Subject: [PATCH 17/29] ia64: remove the hpsim platform
Date:   Wed,  7 Aug 2019 16:30:37 +0300
Message-Id: <20190807133049.20893-18-hch@lst.de>
...
index 0d730b061f72..8f650541d4eb 100644
--- a/arch/ia64/Makefile
+++ b/arch/ia64/Makefile
@@ -52,15 +52,12 @@ core-$(CONFIG_IA64_HP_ZX1_SWIOTLB) += arch/ia64/dig/
...
@@ -69,21 +66,16 @@ compressed: vmlinux.gz
 vmlinuz: vmlinux.gz
